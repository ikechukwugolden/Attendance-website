...
export default function AdminQR() {
  ...
  // The link employees will visit to scan
  ...
  return (
    <div className="flex flex-col items-center space-y-6 p-8 bg-white rounded-[3rem] border border-slate-100 shadow-xl">
      ...
      {/* This is the part that gets turned into an image */}
      <div 
        ref={qrRef} 
      ...
      <div className="flex gap-4 w-full max-w-sm">
        <button
          onClick={downloadQR}
          className="flex-1 bg-slate-900 text-white py-4 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-blue-600 transition-all shadow-xl shadow-blue-900/20"
        >
